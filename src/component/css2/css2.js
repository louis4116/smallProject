...
return <div key={index} className={classes[`time${index}`]}>{index}</div>
 })
  return (
    ...
    <div className={classes.clock}>
        ...
        <div className={classes["hour-hand"]} ref={hourRef} style={{ transform:"translate(-50%)  rotate(0deg)" }}></div>
        <div className={classes["minute-hand"]} ref={minRef} style={{ transform:"translate(-50%)  rotate(0deg)" }}></div>
        <div className={classes["second-hand"]} ref={secRef} style={{ transform:"translate(-50%)  rotate(0deg)" }}></div>
    </div>
